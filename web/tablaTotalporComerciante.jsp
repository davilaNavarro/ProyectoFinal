...
<html>
    ...
    <body class="light-green lighten-5">
        ...
        <%
            ...
            String rut_usu = (String) request.getAttribute("comboComerciante");
        ...
        %>
                ...
                <table>
                    <thead>
                        <tr>
                          <th>MONTO TOTAL DE VENTAS: </th><td><h5>${requestScope.sumaComerciante}</h5></td>
                          <th>CANTIDAD DE VENTAS: </th><td><h5>${requestScope.cantComerciante} </h5> </td>
                        </tr>
                    </thead> 
                </table>
   <% }
    ...
    <table id="tablaPorComerciante" class="responsive-table" >
        <thead>
        ...
        <script>
          $(document).ready(function() {
            ...
            function fnExcelReport() {
                ...
                var textRange;
                var j = 0;
                tab = document.getElementById('tablaPorComerciante'); // id of table
