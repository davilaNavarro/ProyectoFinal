...
<html>
    <head>
        ...
        <title>LISTA DE DESPACHOS REPARTIDOR</title>
    </head>
    ...
    <% if (cliente != null) { %>
        ...
        <h3 class="left-align text-lighten-5"><b>LISTA DE DESPACHOS REPARTIDOR</b></h3>
        <p><b>A CONTINUACIÓN, SE DESPLEGARÁ UNA TABLA CON TODO SUS DESPACHOS REALIZADOS DENTRO DE LAS FECHAS DEFINIDA. </b></p>
        <br>
        ...
        <table >
              <thead>
                <tr align ='center'>
                    ...
                    <th>CANTIDAD DE DESPACHOS:</th><td><h5>${requestScope.cantSumaMensual}</h5> </td>
                </tr>
        </thead>
