<%-- 
    Document   : MenuRepartidor
    Created on : 26-may-2019, 10:29:50
    Author     : DAvil
--%>
...
Push = obtener
Para hacer el pull debo hacer un commit primero.
Pull = subir
...
<html>
    <head>
        ...
        <title>MENÚ REPARTIDOR</title>
    </head>
    <body background="img/cestamedia.jpg" >
           <%
