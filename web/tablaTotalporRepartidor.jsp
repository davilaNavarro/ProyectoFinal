...
<html>
    ...
    <body class="light-green lighten-5">
        ...
        <p><b>A CONTINUACIÓN, SE DESPLEGARÁ LA TABLA DE LOS DESPACHOS REALIZADOS POR EL REPARTIDOR SELECCIONADO.  </b></p>
        ...
        <%
                ...
                String rut_usu = (String) request.getAttribute("cobRepartidor");

                String consulta = "select * from USUARIO where RUT = '"+ rut_usu +"';";
        ...
        %>
                <div class="row">
                    <div class="input-field col s6">
                        <b><h5 class="black-text">RUT REPARTIDOR: </h5></b>
                        <p><h6><%= rs.getString(2)%></h6></p>
                    </div>
                    <div class="input-field col s6">
                        <b><h5 class="black-text">NOMBRE REPARTIDOR </h5></b>
                ...
                <table>
                    <thead>
                        <tr>
                          <th>MONTO TOTAL DE DESPACHOS: </th><td><h5>${requestScope.sumaRepartidor}</h5></td>
                          <th>CANTIDAD DE DESPACHOS: </th><td><h5>${requestScope.cantRepartidor} </h5> </td>
                        </tr>
                    </thead> 
                </table>
   <% }
    ...
    <table id="tablaPorRepartidor" class="responsive-table" >
        <thead>
        ...
        <c:forEach items="${requestScope.lista}" var="c">
            <tr align ='center' class="light-green accent-1">
                    ...
                    <td>${c.MONTO_REPARTO}</td>
                    <td>${c.DIRECCION_DESPACHO}</td>
                    <td>${c.COMUNA_DESPACHO}</td>
          ...
          $(document).ready(function() {
               ...
               function validar()
            {
             ...
             function fnExcelReport() {
                ...
                var textRange;
                var j = 0;
                tab = document.getElementById('tablaPorRepartidor'); // id of table
