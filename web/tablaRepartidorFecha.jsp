...
<html>
    <head>
        ...
        <title>LISTA DESPACHOS POR REPARTIDOR</title>
    </head>
    <body class="light-green lighten-5">
        ...
        <div class="col s12">
         ...
         <h3 class="left-align text-lighten-5"><b>LISTA DE DESPACHOS POR REPARTIDOR</b></h3>
...
%>
                <div class="row">
                    <div class="input-field col s6">
                        <b><h5>RUT REPARTIDOR:</h5></b>
                        <p><h6><%= rs.getString(2)%></h6></p>
                    </div>
                    <div class="input-field col s6">
                        <b><h5>NOMBRE REPARTIDOR: </h5></b>
    ...
    <center>
        <table class="responsive-table">
              <thead>
                ...
                <tr align ='center'>
                    <th>MONTO TOTAL DE DESPACHOS:</th><td><h5>${requestScope.sumaMensual}</h5></td>
                    <th>CANTIDAD TOTAL DE DESPACHOS: </th><td><h5>${requestScope.cantSumaMensual}</h5> </td>
                </tr>
        </thead>
           
           
        <table id="listaRepartidor">
    ...
    <!--Import jQuery before materialize.js-->
        ...
        <script>
                ...
                var textRange;
                var j = 0;
                tab = document.getElementById('listaRepartidor'); // id of table
