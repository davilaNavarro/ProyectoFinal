 ...
 * @author DAvil
 */
public class ListaTotalPorRepartidor {
    ...
    public ListaTotalPorRepartidor() {
    }

    public ListaTotalPorRepartidor(int ID_DESPACHO, String FECHA_HORA_DESPACHO, int MONTO_REPARTO, String DIRECCION_DESPACHO, String COMUNA_DESPACHO, String NOMBRE_CLIENTE, String APELLIDOS_CLIENTE) {
