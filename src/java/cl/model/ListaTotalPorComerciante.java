 ...
 * @author DAvil
 */
public class ListaTotalPorComerciante {
    ...
    public ListaTotalPorComerciante() {
    }

    public ListaTotalPorComerciante(int ID_PRODUCTO, String NOMBRE_PRODUCTO, int MONTO_PRODUCTO, int ID_COMPRA, String FECHA_HORA_COMPRA) {
