...
public class ListaTotalFeria {
    ...
    public ListaTotalFeria() {
    }

    public ListaTotalFeria(int ID_PRODUCTO, String NOMBRE_PRODUCTO, int MONTO_PRODUCTO, int ID_COMPRA, String FECHA_HORA_COMPRA) {
