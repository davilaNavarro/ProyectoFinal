 ...
 * @author DAvil
 */
@WebServlet(name = "ComerciantesPorFechas", urlPatterns = {"/ComerciantesPorFechas"})
public class ComerciantesPorFechas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ComerciantesPorFechas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ComerciantesPorFechas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        String errores="", msg="";
           ...
           String id_comerciante = request.getParameter("cboComerciante");
           request.setAttribute("comboRepar", id_comerciante);
           String fecDesde = request.getParameter("txtfechaDesde");
           request.setAttribute("fecDesdeRepar", fecDesde);
           String fecHasta = request.getParameter("txtfechaHasta");
           request.setAttribute("fecHastaRepar", fecHasta);
           ...
           if(fecHasta.compareTo(fecDesde)>0){
                ...
                ArrayList <cl.model.MensualesCom> listaMenCom = MensualComer.listaMenCom(id_comerciante, fecDesde, fecHasta);
                ...
                request.getRequestDispatcher("tablaComercianteFecha.jsp").forward(request, response);
           }else{
              errores = "Rango de fecha definido incorrecto";
              request.setAttribute("msg", errores);
              request.getRequestDispatcher("listaporComercianteFecha.jsp").forward(request, response);
           }
                  }else{
